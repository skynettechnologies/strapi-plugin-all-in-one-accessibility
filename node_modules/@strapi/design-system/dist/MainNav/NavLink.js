...
`;
const MainNavLinkWrapper = styled__default.default(reactRouterDom.NavLink) `
  position: relative;
...
`;
const NavLink = ({ children, icon, badgeContent, badgeAriaLabel, ...props }) => {
    const condensed = MainNavContext.useMainNav();
    if (condensed) {
        return (jsxRuntime.jsx(Tooltip.Tooltip, { position: "right", label: children, children: jsxRuntime.jsx(MainNavLinkWrapper, { ...props, children: jsxRuntime.jsxs(MainNavRow, { as: "span", children: [jsxRuntime.jsx(IconBox, { "aria-hidden": true, paddingRight: 0, as: "span", children: icon }), badgeContent && (jsxRuntime.jsx(CustomBadge, { condensed: true, "aria-label": badgeAriaLabel, children: badgeContent }))] }) }) }));
    }
    return (jsxRuntime.jsx(MainNavLinkWrapper, { ...props, children: jsxRuntime.jsxs(MainNavRow, { as: "span", justifyContent: "space-between", children: [jsxRuntime.jsxs(Flex.Flex, { children: [jsxRuntime.jsx(IconBox, { "aria-hidden": true, paddingRight: 3, as: "span", children: icon }), jsxRuntime.jsx(Typography.Typography, { children: children })] }), badgeContent && (jsxRuntime.jsx(CustomBadge, { justifyContent: "center", "aria-label": badgeAriaLabel, children: badgeContent }))] }) }));
};
