...
interface RunHookWaterfall {
    <InitialValue, Store>(hookName: string, initialValue: InitialValue, asynchronous: true, store?: Store): Promise<InitialValue>;
    <InitialValue, Store>(hookName: string, initialValue: InitialValue, asynchronous?: false, store?: Store): InitialValue;
}
interface StrapiAppContextValue {
    ...
    getAdminInjectedComponents: (moduleName: InjectionZoneModule, containerName: InjectionZoneContainer, blockName: InjectionZoneBlock) => Array<{
        Component: React.ComponentType;
        name: string;
    }>;
...
declare const StrapiAppProvider: ({ children, getPlugin, getAdminInjectedComponents, menu, plugins, runHookParallel, runHookSeries, runHookWaterfall, settings, }: StrapiAppProviderProps) => import("react/jsx-runtime").JSX.Element;
