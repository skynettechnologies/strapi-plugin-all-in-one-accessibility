...
const AnErrorOccurred = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ...rest,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.ExclamationMarkCircle, { width: "10rem" }),
...
`;
const BaseLink = React__namespace.default.forwardRef(({ href, rel = "noreferrer noopener", target = "_self", disabled = false, isExternal = false, ...props }, ref) => {
...
`;
const LinkWrapper$1 = styled__default.default(BaseLink)`
  display: inline-flex;
  align-items: center;
  ...
  ${buttonFocusStyle};
`;
const Link$1 = React__namespace.default.forwardRef(({ children, href, disabled = false, startIcon, endIcon, isExternal = true, ...props }, ref) => {
  return jsxRuntimeExports.jsxs(LinkWrapper$1, { ref, href, disabled, isExternal, ...props, children: [startIcon, jsxRuntimeExports.jsx(Typography, { textColor: disabled ? "neutral600" : "primary600", children }), endIcon, href && !endIcon && isExternal && jsxRuntimeExports.jsx(icons$1.ExternalLink, {})] });
});
...
const BaseButtonWrapper = styled__default.default(Flex)`
  > svg {
...
const LinkWrapper = styled__default.default(BaseButtonWrapper)`
  text-decoration: none;
  ...
  ${getVariantStyle}
`;
const LinkButton$1 = React__namespace.default.forwardRef(({ variant = "default", startIcon, endIcon, disabled = false, children, size = "S", as = BaseLink, ...props }, ref) => {
...
const LoadingIndicatorPage = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Wrapper, { justifyContent: "space-around", "data-testid": dataTestId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Loader, { children }) });
};
const CheckPagePermissions = ({ permissions = [], children }) => {
  ...
  if (!state.canAccess) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(reactRouterDom.Redirect, { to: "/" });
  }
  return children;
};
...
const Root$1 = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    designSystem.Dialog,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { id: "confirm-description", children }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Footer,
          {
            iconRightButton,
...
const Body$1 = ({ iconBody = /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.ExclamationMarkCircle, {}), children }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.DialogBody, { icon: iconBody, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Flex, { justifyContent: "center", children }) }) });
};
const Footer = ({
  iconRightButton = /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Trash, {}),
  isConfirmButtonLoading,
  leftButtonText,
  onConfirm,
  onToggleDialog,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      startAction: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Button, { onClick: onToggleDialog, variant: "tertiary", children: formatMessage({
...
const ConfirmDialog = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root$1, { ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Body$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { variant: "omega", children: formatMessage({
    id: bodyText.id,
...
const ContentBox = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { shadow: "tableShadow", hasRadius: true, padding: 6, background: "neutral0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IconWrapper, { background: iconBackground, hasRadius: true, padding: 3, children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: endAction ? 0 : 1, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TypographyWordBreak, { fontWeight: "semiBold", variant: "pi", children: title }),
        endAction
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { textColor: "neutral600", children: subtitle })
    ] })
  ] });
};
...
const DateTimePickerLegacy = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.DateTimePicker, { ...props });
};
...
const EmptyStateLayout = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    designSystem.EmptyStateLayout,
    {
      ...
      hasRadius,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { width: "10rem" }),
      shadow
    }
  );
};
const EmptyBodyTable = ({ colSpan, isLoading = false, ...rest }) => {
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tbody, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Td, { colSpan, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { padding: 11, background: "neutral0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Loader, { children: "Loading content..." }) }) }) }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tbody, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Td, { colSpan, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyStateLayout, { ...rest, hasRadius: false }) }) }) });
};
const Table$1 = ({
  action,
  children,
  ...
  const ConfirmDeleteAllComponent = (components == null ? void 0 : components.ConfirmDialogDeleteAll) ? components.ConfirmDialogDeleteAll : ConfirmDialog;
  const ConfirmDeleteComponent = (components == null ? void 0 : components.ConfirmDialogDelete) ? components.ConfirmDialogDelete : ConfirmDialog;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    selectedEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { gap: 3, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { variant: "omega", textColor: "neutral500", children: formatMessage(
        {
      ...
      renderBulkActionsBar ? renderBulkActionsBar({ selectedEntries, clearSelectedEntries }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        designSystem.Button,
        {
          ...
          startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Trash, {}),
          size: "L",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Table, { colCount: COL_COUNT, rowCount: ROW_COUNT, footer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TableHead,
        {
...
const TableHead = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Tr, { children: [
    withMainAction && /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      ({ fieldSchema, name, metadatas: { sortable: isSortable, label, mainField } }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          designSystem.Th,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tooltip, { label: isSortable ? sortLabel : label, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    withBulkActions && /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.VisuallyHidden, { children: formatMessage({
      id: "global.actions",
...
const ActionBar = ({ children }) => {
  ...
  if (selectedEntries.length === 0)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { gap: 2, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { variant: "omega", textColor: "neutral500", children: formatMessage(
      {
        id: "content-manager.components.TableDelete.label",
        defaultMessage: "{number, plural, one {# entry} other {# entries}} selected"
...
const Head = ({ children }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tr, { children }) });
};
const HeaderCheckboxCell = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    designSystem.BaseCheckbox,
    {
      "aria-label": formatMessage({
        id: "global.select-all-entries",
...
const HeaderHiddenActionsCell = () => {
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.VisuallyHidden, { children: formatMessage({
    id: "global.actions",
    defaultMessage: "Actions"
  }) }) });
};
...
const EmptyBody = ({ contentType, ...rest }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tbody, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Td, { colSpan: colCount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyStateLayout, { ...rest, content, hasRadius: false, shadow: void 0 }) }) }) });
};
const LoadingBody = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tbody, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Td, { colSpan: colCount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { padding: 11, background: "neutral0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Loader, { children: "Loading content" }) }) }) }) }) });
};
const Body = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tbody, { children });
};
const Content = ({ children, footer }) => {
  const { rowCount, colCount } = useTableContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Table, { rowCount, colCount, footer, children });
};
const Table = {
  Content,
  Root,
...
const AttributeTag = ({ attribute, filter, onClick, operator, value }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { padding: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Tag, { onClick: handleClick, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Cross, {}), children: content }) });
};
...
const FilterPopoverURLQuery = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Popover, { source, onDismiss: onToggle, padding: 3, spacing: 4, onBlur, children: /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, style: { minWidth: 184 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        designSystem.SingleSelect,
        {
          ...
          children: displayedFilters.map((filter) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: filter.name, children: filter.metadatas.label }, filter.name);
          })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        designSystem.SingleSelect,
        {
          ...
          children: filterList.map((option) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: option.value, children: formatMessage(option.intlLabel) }, option.value);
          })
        }
      )
    ] }),
    operator !== "$null" && operator !== "$notNull" && /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Inputs,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Button, { size: "L", variant: "secondary", startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Plus, {}), type: "submit", fullWidth: true, children: formatMessage({ id: "app.utils.add-filter", defaultMessage: "Add filter" }) }) })
  ] }) }) });
};
...
const DefaultInputs = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  if (type === "boolean") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.SingleSelect, { "aria-label": label, onChange: (value2) => onChange(String(value2)), value, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: "true", children: "true" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: "false", children: "false" })
    ] });
  }
  if (type === "date") {
    return (
  ...
  if (type === "enumeration") {
    return (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelect, { "aria-label": label, onChange, value, children: options.map((optionValue) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: optionValue, children: optionValue }, optionValue);
      }) })
    );
  }
  if (["float", "integer", "biginteger", "decimal"].includes(type)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Field, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Form = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(formik.Form, { ref: formRef, ...props, noValidate: true });
};
        ...
        designSystem.TextInput,
        {
          ...
          endAction: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              type: "button",
              children: showPassword ? /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Icon, { as: icons$1.Eye, color: "neutral500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Icon, { as: icons$1.EyeStriked, color: "neutral500" })
            }
          ),
          label,
          labelAction,
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        designSystem.SingleSelect,
        {
          ...
          children: options.map(({ metadatas: { intlLabel: intlLabel2, disabled: disabled2, hidden }, key, value: value2 }) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: value2, disabled: disabled2, hidden, children: formatMessage(intlLabel2) }, key);
          })
        }
      );
    }
...
const InjectionZone = ({
  ...
  return components.map(({ name, Component }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { ...props }, name));
};
/**
 * @preserve
 *
 ...
 */
const Link = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link$1, { ...props, as: reactRouterDom.NavLink });
/**
 * @preserve
 *
 * @deprecated Use @strapi/design-system LinkButton instead.
 */
const LinkButton = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(LinkButton$1, { ...props, as: reactRouterDom.NavLink });
const NoContent = ({
  content = {
    id: "app.components.EmptyStateLayout.content-document",
    defaultMessage: "No content found",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ...rest,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.EmptyDocuments, { width: "10rem" }),
      content: formatMessage(
        { id: content.id, defaultMessage: content.defaultMessage },
        content.values
      )
...
const NoMedia = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.EmptyStateLayout, { ...props, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.EmptyPictures, { width: "10rem" }) });
};
const NoPermissions = ({ action }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    designSystem.EmptyStateLayout,
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.EmptyPermissions, { width: "10rem" }),
      content: formatMessage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { gap: 2, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      designSystem.SingleSelect,
      {
        ...
        value: pageSize,
        children: options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SingleSelectOption, { value: option, children: option }, option))
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { textColor: "neutral600", as: "span", children: formatMessage({
      id: "components.PageFooter.select",
      defaultMessage: "Entries per page"
    }) })
  ] });
...
const PaginationURLQuery = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Pagination, { activePage, pageCount, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.PreviousLink, { active: false, to: { pathname, search: previousSearch }, children: formatMessage({
    ...
    items.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Dots, {}, item);
    }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.NextLink, { active: false, to: { pathname, search: nextSearch }, children: formatMessage({
...
const ClearIndicator = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconBox$1, { as: "button", type: "button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Cross, {}) }) });
};
...
const DropdownIndicator = ({ innerProps }) => {
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CarretBox, { paddingRight: 3, ...innerProps, children: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.CarretDown, {}) })
  );
};
...
const SearchURLQuery = ({
  ...
  const [{ query }, setQuery] = useQueryParams();
  const [value, setValue] = React__namespace.useState((query == null ? void 0 : query._q) || "");
  ...
  if (isOpen) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.SearchForm, { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref: iconButtonRef,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Icon, { as: icons$1.Search, color: "neutral800" }),
...
const SettingsPageTitle = ({ name }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactHelmet.Helmet, { title: text });
};
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  var _a;
  const { formatMessage } = reactIntl.useIntl();
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? Ce.createPortal(
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Overlay$1, { id: "autoReloadOverlayBlocker", direction: "column", alignItems: "center", gap: 6, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(designSystem.Flex, { direction: "column", alignItems: "center", gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { as: "h1", variant: "alpha", children: formatMessage(title) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Typography, { as: "h2", textColor: "neutral600", fontSize: 4, fontWeight: "regular", children: formatMessage(description) })
      ] }),
      ...
      displayedIcon === "time" && /* @__PURE__ */ jsxRuntimeExports.jsx(IconBox, { padding: 6, background: "primary100", borderColor: "primary200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Clock, { width: pxToRem(40), height: pxToRem(40) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(designSystem.Box, { marginTop: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link$1, { href: "https://docs.strapi.io", isExternal: true, children: formatMessage({
...
const OverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(OverlayBlockerContext.Provider, { value: contextValue, children: [
    children,
    isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? Ce.createPortal(/* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { id: "overlayBlocker" }), globalThis.document.body) : null
  ] });
};
...
const RemoveRoundedButton = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(StyledIconButton, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(icons$1.Minus, {}), ...props });
